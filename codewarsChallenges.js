...
// If you rent the car for 7 or more days, you get $50 off your total. Alternatively, if you rent the car for 3 or more days, 
// you get $20 off your total. Write a code that gives out the total amount for different days(d).

function rentalCarCost(d) {
  // Your solution here
  const carrate = 40;
  
  let totalperDay = d*carrate; 
...
function findDifference(a, b) {
  //loading...
const itemOne = a[0] * a[1] * a[2];
const itemTwo = b[0] * b[1] * b[2];
const findDifference = Math.abs( itemOne- itemTwo);
...
//  each dragon takes 2 bullets to be defeated, our hero has no idea how many bullets he should carry.. Assuming he's gonna grab a specific 
//  given number of bullets and move forward to fight another specific given number of dragons, will he survive?
// Return true if yes, false otherwise :)

function hero(bullets, dragons){
  chances = bullets /2 >= dragons; 
    return chances;
